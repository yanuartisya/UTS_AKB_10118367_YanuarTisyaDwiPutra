...
import net.abk.a10118367_yanuartisyadwiputra_uts.database.DatabaseHelper;
import net.abk.a10118367_yanuartisyadwiputra_uts.database.model.Note;
import net.abk.a10118367_yanuartisyadwiputra_uts.utils.Divider;
import net.abk.a10118367_yanuartisyadwiputra_uts.utils.Recycle;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new Recycle(this,
                recyclerView, new Recycle.ClickListener() {
            @Override
        ...
        buttomNavigationView.setSelectedItemId(R.id.home);
